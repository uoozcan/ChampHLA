#!/bin/bash
#SBATCH --job-name=pihla_wgs_dl_wave2
...
#SBATCH --output=/scratch/project_2008084/hla_calibration/logs/wgs_dl_wave2_%A_%a.out
#SBATCH --error=/scratch/project_2008084/hla_calibration/logs/wgs_dl_wave2_%A_%a.err

# Downloads HLA-region BAMs for the 49 WGS samples needed to match WES/RNA-seq cohort.
# Streams chr6:28000000-34000000 from NYGC 30x CRAMs at EBI.
...
mkdir -p "${OUT_DIR}" "${REF_CACHE}" /scratch/project_2008084/hla_calibration/logs

...
# Regenerate publication-quality figures (PNG 300dpi + PDF) from the
# tri-modal benchmark (benchmark_trimodal_all_samples, all cohort samples).
#
# Usage:
...
python3 $SCRIPT \
  --tables_dir $REPO/analysis/benchmark_trimodal_all_samples/tables \

#!/bin/bash
#SBATCH --job-name=giab_rna_HG003
...
INDEX=/scratch/project_2008084/pihla-publish/analysis/giab_trio_benchmark/index/rna_single_HG003.tsv
WORK=/scratch/project_2008084/hla_calibration/work/giab_rna_HG003
SUBN=30000000

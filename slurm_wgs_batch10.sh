#!/bin/bash
#SBATCH --job-name=pihla_wgs_b10
#SBATCH --account=project_2008084
#SBATCH --partition=small
#SBATCH --time=24:00:00
#SBATCH --cpus-per-task=2
#SBATCH --mem=8G
#SBATCH --output=/scratch/project_2008084/pihla-publish/analysis/logs/wgs_batch10_%j.out
#SBATCH --error=/scratch/project_2008084/pihla-publish/analysis/logs/wgs_batch10_%j.err

# Downloads HLA-region BAM from NYGC 30x CRAM, types HLA, then cleans the BAM.
# Usage: sbatch slurm_wgs_batch10.sh <sample1> [sample2 ...]

set -euo pipefail

INDEX=/scratch/project_2008084/hla_calibration/wgs/index/sample_cram_urls_batch2.tsv

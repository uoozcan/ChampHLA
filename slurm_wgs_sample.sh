#!/bin/bash
#SBATCH --job-name=pihla_wgs_sample
#SBATCH --account=project_2008084
#SBATCH --partition=small
#SBATCH --time=24:00:00
#SBATCH --cpus-per-task=2
#SBATCH --mem=8G
#SBATCH --output=/scratch/project_2008084/hla_calibration/logs/wgs_sample_%x_%j.out
#SBATCH --error=/scratch/project_2008084/hla_calibration/logs/wgs_sample_%x_%j.err
...
sample_id="$1"
input_root="${2:-/scratch/project_2008084/hla_calibration/wgs/bams_new}"
output_root="${3:-/scratch/project_2008084/hla_calibration/wgs_batches}"
